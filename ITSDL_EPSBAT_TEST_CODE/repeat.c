...
int main(void) {
  ...
  while (1) {
    ...
    //           W/m^2 , "
    //           "%02f W/m^2 ,",
    //           VPCMBATV, IPCM12V, VPCM12V, IPCM5V, VPCM5V, IPCM3V3, VPCM3V3,
    //           VSW[0], VSW[1], VSW[2], VSW[3], VSW[4], VSW[5], VSW[6], VSW[7],
    //           VSW[8], VSW[9], ISW[0], ISW[1], ISW[2], ISW[3], ISW[4], ISW[5],
    //           TRCRA[0], TRCRA[1], TRCRA[2], TRCRA[3], TRCRA[4], TRCRA[5],
    //           TRCRA[6], TRCRA[7], TRCRA[8], TRCRB[0], TRCRB[1], TRCRB[2],
    //           TRCRB[3], TRCRB[4], TRCRB[5], TRCRB[6], TRCRB[7], TRCRB[8],
    //   write(fd_txt, buf, strlen(buf));
